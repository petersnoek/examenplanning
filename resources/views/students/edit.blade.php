    ...
    <div class="content col-lg-12">
        ...
        <div class="block block-themed  remove-padding animated @if($errors->isEmpty()) bounceInLeft @else shake @endif">
            ...
            <div class="block-content">
                <form class="form-horizontal push-10-t push-10" action="/students/{{$student->id}}" method="POST"
                      onsubmit="">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-material">
                                ...
                                <div class="input-group form-material">
                                    <input class="form-control" type="text" id="voornaam" name="voornaam"
                                           value="{{$student->voornaam}}" placeholder="Vul de voornaam in..." required>
                            ...
                            <div class="form-material">
                                ...
                                <div class="form-material input-group">
                                    <input class="form-control" type="text" id="tussenvoegsel" name="tussenvoegsel"
                                           value="{{$student->tussenvoegsel}}" placeholder="Vul tussenvoegsel in...">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-material">
                                ...
                                <div class="input-group form-material">
                                    <input class="form-control" type="text" id="achternaam" name="achternaam"
                                           value="{{$student->achternaam}}" placeholder="Vul de achternaam in..." required>
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-material input-group">
                                <input class="form-control" type="email" id="email" name="email"
                                       value="{{$student->email}}" placeholder="Vul het email-adres in..." required>
                            ...
                            <div class="form-material">
                                ...
                                <div class="form-material input-group">
                                    <input class="form-control" type="text" id="adres" name="adres"
                                           value="{{$student->adres}}" placeholder="Vul het adres in..." required>
                            ...
                            <div class="form-material">
                                ...
                                <div class="form-material input-group">
                                    <input class="form-control" type="text" id="ovnummer" name="ovnummer"
                                           value="{{$student->ovnummer}}" placeholder="Vul het OV-nummer in..." required>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div>
                                <label class="css-input css-radio css-radio-warning push-10-r">
                                    <input type="radio" @if($student->geslacht == 'vrouw') checked="checked" @endif  value="vrouw" name="geslacht"
                                           required><span></span>
                                    Vrouw
                                </label>
                                <label class="css-input css-radio css-radio-warning">
                                    <input type="radio" value="man" @if($student->geslacht == 'man') checked="checked" @endif name="geslacht"><span></span> Man
                                </label>
                            </div>
