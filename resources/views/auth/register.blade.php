...
@section('content')
    <div class="col-lg-4 push-30-t col-lg-push-4 js-animation-object animated @if ($errors->has('name') || $errors->has('email') || $errors->has('password')) shake @else bounceInLeft @endif">
        <!-- Material Register -->
            ...
            <div class="block-content">
                <form class="form-horizontal push-10-t push-10" method="POST" action="{{ route('register') }}"
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="form-material input-group">
                                <input class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" type="email" id="register2-email" name="email"
