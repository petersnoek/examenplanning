        ...
        <div class="row push-30-t items-push-2x">
            ...
            <div class="col-sm-4">
                ...
                <div class="font-s13 push">
                    <strong>Da Vinci College</strong><br>
                    Romboutslaan 34<br>
                    3312 KP, Dordrecht<br>
                </div>
                <div class="font-s13">
                    <i class="si si-call-out"></i> <!-- <abbr title="Telefoon">T:</abbr>--> <a href="tel:088-657 2657">088-657 2657</a> <br>
                    <i class="si si-envelope-open"></i> <a href="mailto:webmaster@davinci.nl">webmaster@davinci.nl</a>
                </div>
            </div>
        </div>
