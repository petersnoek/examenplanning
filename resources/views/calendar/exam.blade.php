                ...
                <table class="block-table text-center bg-gray-lighter border-b">
                    ...
                    <tr>
                        <td class="border-r col-lg-4">
                            ...
                            <div class="h5 text-muted text-uppercase push-5-t">{{isset($exam->slots) ? \Carbon\Carbon::parse($exam->slots->datum)->format('d-m-Y') : 'Nog geen datum gepland'}}</div>
                        </td>
                        <td class="border-r col-lg-4">
                            <div><i class="fa fa-fw fa-4x fa-clock-o push-5-r"></i></div>
                            <div class="h5 text-muted text-uppercase push-5-t">{{isset($exam->slots) ? \Carbon\Carbon::parse($exam->slots->starttijd)->format('H:i') . '-' . \Carbon\Carbon::parse($exam->slots->eindtijd)->format('H:i') : 'Nog geen datum gepland'}}</div>
                        </td>
                        <td class="col-lg-4">
